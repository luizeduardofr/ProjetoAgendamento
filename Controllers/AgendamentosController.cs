...
namespace ProjetoAgendamento.Controllers
{
    public class AgendamentosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["servicoID"] = new SelectList(_context.Servicios, "id", "descricao");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("id,dataDisponivel,funcionarioID,servicoID,clienteID")] Agendamento agendamento)
        {
            ...
            ViewData["servicoID"] = new SelectList(_context.Servicios, "id", "descricao", agendamento.servicoID);
            return View(agendamento);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,dataDisponivel,funcionarioID,servicoID,clienteID")] Agendamento agendamento)
        {
